...
var prepare = function prepare($elements, options) {
  $elements.forEach(function (el, i) {
    ...
    var customClassNames = options.useClassNames && el.node.getAttribute('');
...
var disable = function disable() {
  $aosElements.forEach(function (el, i) {
    el.node.removeAttribute('');
    el.node.removeAttribute('-easing');
    el.node.removeAttribute('-duration');
    el.node.removeAttribute('-delay');
...
var init = function init(settings) {
   ...
   * so CSS can use it
   */
  document.querySelector('body').setAttribute('-easing', options.easing);

  document.querySelector('body').setAttribute('-duration', options.duration);

  document.querySelector('body').setAttribute('-delay', options.delay);
